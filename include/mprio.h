...
#define BBIT_PREC_MAX (int)MIN(sizeof(long) * CHAR_BIT - 12, 42)
   ...
   */
  PrioConfig PrioConfig_new_uint(int nUInts,
                                 int prec,
                                 PublicKey serverA,
                                 PublicKey serverB,
                                 const unsigned char* batchId,
   ...
   * `for_server_b` to avoid memory leaks.
   */
  SECStatus PrioClient_encode_uint(const_PrioConfig cfg,
                                   const int prec,
   ...
   */
  SECStatus PrioTotalShare_final_uint(const_PrioConfig cfg,
                                      const int prec,
                                      unsigned long long* output,
                                      const_PrioTotalShare tA,
                                      const_PrioTotalShare tB);
